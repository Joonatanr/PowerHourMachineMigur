...
{
 {  .port = GPIO_PORT_P2, .pin = GPIO_PIN7 },      /* BLUE_BUTTON       */
 {  .port = GPIO_PORT_P2, .pin = GPIO_PIN6 },      /* YELLOW_BUTTON     */
 {  .port = GPIO_PORT_P2, .pin = GPIO_PIN4 },      /* RED_BUTTON        */
 {  .port = GPIO_PORT_P5, .pin = GPIO_PIN6 },      /* GREEN_BUTTON      */
};
